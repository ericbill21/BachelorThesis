...
By putting all theorems into perspective, we can conclude that the ability \wldisc is very powerful, so we can assume that \wlnn is sufficiently expressive for the upcoming empirical part. \todo{Redo, remove gapps and co!}
