\documentclass[11pt, dvipsnames, DIV=12]{scrreprt} %twoside
\usepackage{babel}
...
% 1-WL+NN
\newcommand{\wlnn}{\textsf{1-WL+NN}\xspace}
...
\end{tikzpicture}
%{The present work was submitted to the Computer Science 6: Machine Learning on Graphs\hfill}
\vspace{50pt}
