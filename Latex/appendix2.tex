...
\todo{Update table and highlight best parameters}
...
\todo{Table for \gnn and regression is missing!}


\begin{table}[H]
    \caption{Overview of the number of different configurations tested for each model type and each dataset. TODO: Format once all experimtents are finished!}
    \label{tab:num_runs}
    \resizebox{.975\textwidth}{!}{ 	\renewcommand{\arraystretch}{0.9}
