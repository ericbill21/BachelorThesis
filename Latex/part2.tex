...
In order to limit the amount of hyperparameters that need testing and to make the results comparable to other works, we adhered to common pracitices when configurig the models.

We listed all hyperparameter as well as the hyperparameter we sweeped over, in full detail in Table 2 for the \wlnn models used for classification tasks, Table 3 for the \gnn models used for classification tasks and Table 5 for \wlnn models employed for regression task in the Appendix. We will shortly discuss the most important parameters we sweep over.

First of all, as a matter of fact and to make the \wlnn models even capable of learning something we adpated
