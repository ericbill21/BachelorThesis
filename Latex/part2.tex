...
\begin{table}
    \resizebox{.975\textwidth}{!}{ 	\renewcommand{\arraystretch}{1.05}
		\begin{tabular}{@{}c <{\enspace}@{}lcccccc@{}}	\toprule
			...
			\\ 
			& \textsf{GIN:Mean}  & \textbf{31.7} \scriptsize $\pm 6.7$	& \textbf{71.1} \scriptsize $\pm 5.4$ & 0.0 \scriptsize $\pm 0.0$ & 	70.8 \scriptsize $\pm 2.2$ & 72.0 \scriptsize $\pm 4.0$ & 0.0 \scriptsize $\pm 0.0$
			\\ 
...
\begin{table}
    \resizebox{.975\textwidth}{!}{ 	\renewcommand{\arraystretch}{1.05}
		\begin{tabular}{@{}c <{\enspace}@{}lcccccccc@{}}	\toprule
			...
			& & {\textsc{Enzymes}}         &  {\textsc{Imdb-Binary}}  & {\textsc{Imdb-Multi}}  & {\textsc{Mutag}}           & {\textsc{NCI1}}       & {\textsc{Proteins}}  & {\textsc{Reddit-Binary}} & {\textsc{Reddit-Multi}}
			\\
			\toprule
			\multirow{6}{*}{} 	&
			\textsf{0}       &  81.4 & 60.6 & 44.2 & 93.1 & 91.3 & 91.9 & 83.9 & 55.1
			\\ 
			& \textsf{1}   & 100 & 88.6 & 63.3 & 95.7 & 99.5 & 99.7 & - & 100
			\\
			& \textsf{2}   & - & - & - & 99.5 & 99.8 & - & - & -
			\\
			& \textsf{3}   & - & - & - & 100 & 99.8 & - & - & -
			...
			& Max Accuracy     & 55.9  \scriptsize	$\pm 1.0$         & 73.0     \scriptsize $\pm 0.7$          & 50.1 \scriptsize $\pm 0.9$            & 85.6  \scriptsize $\pm 1.4$          & 84.6  \scriptsize $\pm 0.3$         & 75.1 \scriptsize $\pm 0.5$           
			\\
			\bottomrule
		\end{tabular}}
        \caption{Some caption!}
