...
\begin{table}
    \resizebox{.975\textwidth}{!}{ 	\renewcommand{\arraystretch}{1.05}
		\begin{tabular}{@{}c <{\enspace}@{}lcccccccc@{}}	\toprule
			...
			\bottomrule
		\end{tabular}}
        \caption{An overview of the maximum theoretical classification accuracy achievable for each dataset based on the number of 1-WL iterations in percent.  Moreover, each hyphen indicates that the maximum accuracy has converged with fewer 1-WL iterations.}
        \label{tab:my_label2}                  
\end{table}
