\begin{tikzpicture}
    ...
    \node (firstV) [right =of coloring] {$f^*(v)$};
    \node (inp1) [above right =of firstV] {$f_1(v)$};
    \node (inp2) [below right =of firstV] {$f_n(v)$};
    ...
    \draw[-latex] (coloring.east) -- (firstV.west);
    ...
    \draw[|-latex] (out.east) to node[text width=2.5cm,midway,above,align=center] {$\mlp^*$} (final_out.west);
